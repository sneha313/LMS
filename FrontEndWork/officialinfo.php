...
<html>
	...
	<body>
		<?php 
			...
			//$empinfo=$db->pdoQuery("select * from emp where empname='".$fullname."'");
			//$emprow=$empinfo->results();
			...
			//$empprofile=$db->pdoQuery("select * from empprofile where empid='".$empid."'");
			//$row=$empprofile->results();
			...
			//$subdepartment=$db->pdoQuery("select d.subDept from departments d join emp e on e.dept=d.mainDept where (e.empid=?);",array($empid));
	?>
