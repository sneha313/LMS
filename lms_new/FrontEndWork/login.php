		...
		<nav class="navbar navbar-inverse">
			<div class="container">
				<div class="navbar-header">
					<div id="img">
						<img class="img-responsive" src="public/img/3.jpg" style="height:70px;">
					</div>
					...
					<div class="row"><!-- row start-->
						<div class="col-sm-5" id="left-part">
							<div id="heading">
								...
								<li>LMS link will <b>work </b>only when you are in the ECI Domain.</li>
								</ul>
								...
								<div class="row">
									<div class="col-sm-8">
										...
										<div class="row">
											...
											<div class="col-sm-6">
												<a href="needhelp.php"><i class="fa fa-question-circle" data-aria-hidden="true"></i><b> Need Help</b></a>
											</div>
											<div class="col-sm-3"></div>
										</div>
									</div>
				...
				$("#login_form").submit(function()
				{
					...
					$.post("ajax_login.php",{ user_name:$('#username').val(),password:$('#password').val(),rand:Math.random() } ,function(data)
					{
					   if(data=='yes') //if correct login detail
						{
						  /* $(this).popover({title: "Leave detail Info", content: "Logging in.....", delay: {show: 500, hide: 100}}).addClass('messageboxok').fadeTo(900,1,
									  function()
									  { 
						...
						else if(data=='nodata') 
						{
							...
							{ 
							  ...
							  $(this).html('Leave details is not available. Please contact HR').fadeTo(900,1);
								//$(this).popover({title: "Leave detail Info", content: "Leave details is not available. Please contact HR", delay: {show: 500, hide: 100}}); 
							});		
						}
						else 
						{
							...
							{ 
							  ...
							  $(this).html('Your login detail wrong...'+data).addClass('messageboxerror').fadeTo(900,1);
								//$(this).popover({title: "Leave detail Info", content: "Your login detail wrong...", delay: {show: 500, hide: 100}}); 
