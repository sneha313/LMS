...
<html>
	...
	<body>
		...
		<div class="container-fluid">
			<!--row start-->
			<div class="row">
				<form id="AttInd" name="AttInd" method="post" action="voe.php?insert=1">
					<div class="col-sm-12"><!-- 11 column start -->
						<div class="panel panel-primary"><!-- panel div start -->
												...
												<div class='row'>
													...
													if($count!=0) {
														...
														while ($row = $db->fetchArray($rs))
														{
															...
															<div class='col-sm-4'>
																<input type='text' class=fomr-control' readonly value='$employee_name' id='employee_name' name='employee_name'/>&nbsp;<span class='errmsg' id='errmsg6'></span>
															</div>
															</div></div>";
															echo "<div class='form-group'>
																	<div class='row'>
															...
															echo "<div class='form-group'>
																	<div class='row'>
																		<div class='col-sm-2' class='dynamic'>
																			<label>Distance between residence and office of employee:</label>
																		</div>
																		<div class='col-sm-4'>
															...
															echo "<div class='form-group'>
																	<div class='row'>
																		...
																		<div class='col-sm-4'>
																			<input type='text' class='input' type='text' id='expenses' name='repairs_maintence_expenses' onchange='totalVoe();' value='$repairs'/> &nbsp;<span class='errmsg' id='errmsg3'></span>
																		</div>
																	</div>
																</div>";
															echo "<div class='form-group'>
