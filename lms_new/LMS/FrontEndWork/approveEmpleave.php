		...
		<?php
			if(isset($_REQUEST['role']))
			{
			    ...
			    if($_REQUEST['role']=="manager") {
			    	$divid="loadmanagersection";echo "<script>var divid=\"loadmanagersection\";</script>"; 
			    }
			    if($_REQUEST['role']=="hr") { 
			    	$divid="loadhrsection";echo "<script>var divid=\"loadhrsection\";</script>";
			    }
			}
		?>
			...
			<?php
				...
				echo '<form action="approveEmpleave.php" method="POST" id="getemptrans">
						<div class="row"> 
					        ...
					        <div class="col-sm-4">
								<input id="empuser" type="text" class="form-control ui-autocomplete-input" name="empuser" value="" autocomplete="off"/>
							</div>
							<div class="col-sm-3">
