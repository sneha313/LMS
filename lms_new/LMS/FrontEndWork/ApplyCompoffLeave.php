					...
					<div class='form-group'>
						<div class='row'>
							<div class='col-sm-12 text-center'>
								<input type='submit' class='btn btn-info' id='add' value='Add Compoff Leaves' onclick='generateLeaves()'/>
...
if(isset($_REQUEST['add']))
{
	...
	exec($cmd);
	echo '<script>
				BootstrapDialog.alert("Compoff Leave Applied");
				...
				$("document").ready(function() {
					$("#compoff").validate({
						submitHandler: function() {
							if (BootstrapDialog.confirm("Do you want to apply Compoff leave?"))
						  	{
						  		$.ajax({ 
