 <?php
	...
	if (isset($_REQUEST['table'])) 
	{
   		...
   		if($count != 0)
    	{
    		...
    		echo "<tr><td>Total Days</td><td><input readonly type='text' class='form-control' id='total_days' value='$total'/></td><td><input readonly type='text'id='totaltoandfrokms' value='$total_distance'/></td><td><input readonly type='text'/></td><td><input readonly type ='text' id='overall_cost'value='$overall_cost'/></td></tr>";
    	} else {
	    	$employee_number=$_SESSION['u_empid'];
	...
	echo "<tr><td>Total Days</td><td><input readonly type='text' class='form-control' id='total_days' value='$total_days'/></td><td><input type='text'id='totaltoandfrokms' value='$total_distance'/></td><td><input readonly type='text'/></td><td><input readonly id='overall_cost'value='$overall_cost' name='total_fuelcost'/></td>
	<td><input type='submit' class='btn btn-info' id='addrow' value='ADD DAY' onclick='addRow();'/></td></tr>";
	}
	}
