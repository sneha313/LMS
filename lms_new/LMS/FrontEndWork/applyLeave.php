  								...
  								<div class="panel-body table-responsive">
									<table class="table table-bordered table-hover">
										...
										<tr>
											...
											<td>Need to mention the worked holiday date to <b>apply Comp Off Leave</b>. </td>
										</tr>
										<tr>
											<td><a href="#">Pending Leaves</a></td>
											<td>User can Edit/Delete leave, if <b>applied leave</b> is in <b>pending state</b>.</td>
										</tr>
									</table>
  								</div>
							</div>
