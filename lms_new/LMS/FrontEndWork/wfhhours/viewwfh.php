...
<?php
	echo '<html>
		<head>
			<link rel="stylesheet" type="text/css" media="screen" href="css/selfleavehistory.css" />
		...
		<body>
					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-sm-12 text-center">
								<input type="submit" class="btn btn-info" id="submit" name="submit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
			...
			<?php 
				...
				<div class="panel panel-primary">
					<div class="panel-heading text-center">
						<strong style="font-size:20px;">View WFH Details</strong>
					</div>
					<div class="panel-body">';
					...
					foreach ($distinctYears as $year) {
						...
						for($i=0;$i<$db->countRows($sql1);$i++)
						{
							...
							if(strtoupper($row['status'])=='PENDING'){
								echo '<td>';
								echo '<input type="submit" class="btn btn-danger" onclick=deletewfh("'.$row['tid'].'") id="delete" name="delete"><i class="fa fa-trash" aria-hidden="true"></i>';
								echo '<input type="submit" class="btn btn-info" onclick=editwfh("'.$row['tid'].'") name="Edit" style="padding:1px 15px;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>';
								echo '</td>';
							}
							else 
							{
