		...
		<form class="form-horizontal" id="edit-form" method="POST">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					<div class="row">
						<div class="col-sm-4 control-label">
							<label for="subdept">Sub Dept</label>
						</div>
						<div class="col-sm-8">
				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="deptloc" name="deptloc" placeholder="Enter Department Location">
					    </div>
					 </div>
				</div>
				<div class="form-group">
					<div class="row">
						...
						<div class="col-sm-8">
							<input type="email" class="form-control" id="deptmail" name="deptmail" placeholder="Enter Department Location">
					    </div>
					</div> 
				</div>
		      	...
		      	<div class="modal-body">
					...
					<div class="form-group">
	      				<div class="row">
					    	...
					    	<div class="col-sm-8">
					   			<input type="text" class="form-control" id="add_deptloc" name="add_deptloc" placeholder="Enter Department Location" required>
					   		</div>
						</div>
					</div>
					<div class="form-group">
