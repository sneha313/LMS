					...
					<div class="panel-body">
							...
							if (($_SESSION['u_managerlevel'] != 'level1') || ($_SESSION['user_dept'] == 'HR')) {
								...
								echo '<div class="form-group" id="hideEmpName">
									...
									<div class="col-sm-4"><label>Name:</label></div>
									<div class="col-sm-8">
									<select class="form-control" size="0" name="UGroup">
										'.$deps.'
									</select>
									</div>
									</div>
							...
							if($_SESSION['u_emplocation'] != 'MUM')
							{
							 echo '<div class="form-group">
									<div class="row">
									<div class="col-sm-4"><label>Before 10 and After 4</label>
									</div>
								<div class="col-sm-8">
							...
							<div class="row">
							<div class="col-sm-4"><label><?php echo $dayhours; ?>
							Hr/Day:</label></div>
							<div class="col-sm-8"><select class="form-control" size="1" name="AdvCond2">
							<option value="NOTMEET" selected>Not Meet</option>
							<option value="MEET">Meet</option>
							</select></div>
							</div>
							...
							<div class="form-group">
							<div class="row">
							<div class="col-sm-4"><label><?php echo $dayhours * 5; ?>
							Hr/Week:</label>
							</div>
							<div class="col-sm-8"><select class="form-control" size="1" name="AdvCond3">
							<option value="NOTMEET" selected>Not Meet</option>
							<option value="MEET">Meet</option>
							</select></div>
							</div>
							...
							<div class="form-group">
							<div class="row">
							<div class="col-sm-4"><label>From:</<label>
							</div>
							<div class="col-sm-8">
...
function getDataForEMP($empID,$empName,$first,$last,$P10to4,$hr9,$hr45) {
	...
	while ($w1 < date('Y-m-d',strtotime(getFriday($last)))) {
		...
		$subempinfo=$subempinfo. '<tr>
				...
				<th class="info">In</th>
				<th class="info">Out</th>
				<th class="info">total Hr</th>
				<th class="info">WFH</th>
				<th class="info">Total WFH</th>
				<th class="info">Type Of day</th>
			</tr>';
		$w1= date('Y-m-d', strtotime("$wkst 7 day"));
		$tmpDate='00:00:00';
	...
	echo '
				<table class="table table-bordered">
					<tr>
						...
						<th class="info">No of days';
	if ($P10to4 == "NOTMEET") {
		echo ' after ';
	} else {
		echo ' before ';
	}
	echo '10 AM</th><th class="info">No of days';
	if ($P10to4 == "NOTMEET") {
		echo ' before ';
	} else {
		echo ' after ';
	}	
	echo '4 PM</th><th class="info">No of Daily Hr-';
	echo $hr9;
	echo '</th><th class="info">No of Total Hr-';
	echo $hr45;
	echo ' </th><th class="info"> Graph</th></tr>';
}
