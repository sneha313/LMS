...
if (array_key_exists('oper', $_REQUEST)) {
	...
	//echo ("<h3 align='center'>Holidays List</h3>
			//<hr />");
	echo "	
		...
		<nav class='navbar navbar-inverse'>
			<div class='container'>
				...
				<ul class='nav navbar-nav navbar-right'>
					<li><a href='#' style='font-size:16px; color:white; padding-top:20px; padding-right:30px; font-family:cursive;'><b> Welcome, Victoria</b></a></li>
		...
		<!--2 column start-->
			<div class='col-sm-2'>
				...
				<h6 class='text-center' style='color:white; font-size:14px; font-family:Times New Roman, Georgia, Serif;'> Victoria</h6>
				
					 <center><span class='text-size-small' style='color:white;'>BLR,India
					</span>
					</center>
		</div>
