...
if (array_key_exists('getData',$_REQUEST)) 
	...
	includeJQGrid();
        ...
        colModel :[ 
          ...
          {name:'empid', index:'empid', width:50,editable:true,editoptions:{size:10},editrules:{required:true}}, 
          {name:'empusername', index:'empusername', width:80,editable:true, align:'left'}, 
          {name:'empname', index:'empname', width:120,editable:true,align:'center'}, 
          {name:'emp_emailid', index:'emp_emailid', width:80,editable:true,align:'center',hidden:true},
          {name:'dept', index:'dept', width:80,editable:true,edittype:'select',editoptions:{dataUrl:'eciemp.php?deptSelect=1'},align:'center'},
          {name:'joiningdate', index:'joiningdate', width:80,editable:true,align:'center'},
          {name:'birthdaydate', index:'birthdaydate', width:80,editable:true,align:'center',hidden:true}, 
          {name:'role', index:'role', width:80,editable:true,edittype:'select',editoptions:{value:'user:user;Manager:Manager;HR:HR'},align:'center'},
		  ...
		  {name:'location', index:'location',align:'center',width:80},
   ...
   <body>
     <h3 align='center'>V&V Group Information</h3>
     <hr />
