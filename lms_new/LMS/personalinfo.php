...
if(isset($_REQUEST['update']))
{
	...
	{
		$sql = $db->query("UPDATE empprofile SET address ='".$address."',phonenumber = '".$phoneno."',bloodgroup='".$bloodgrp."',fathername='".$father."'  WHERE empid='".$_SESSION['u_empid']."'");
		if($sql){
		...
		$sql = $db->query("INSERT INTO empprofile (empid ,address ,phonenumber,fathername, bloodgroup)
				VALUES ('".$_SESSION['u_empid']."', '".$address."', '".$phoneno."','".$father."','".$bloodgrp."')");
			...
			<div class="panel panel-primary">			
				...
				<div class="panel-body">
					...
					<div class="row"><!--2nd row start-->
						...
						<div class="col-sm-4">
							<input type="text" class="form-control"  name='phonenum' id='phonenum' value="<?php echo $phonenumber; ?>">
						</div>
							...
							<div class="row"><!--3rd row start-->
								...
								<div class="col-sm-4">
									<table class="table table-bordered table-hover table-striped" style="margin-left:-20px">
										...
										<?php for($i=0;$i<$db->countRows($teamres);$i++)
							 				{
